...
class TestSimulatedSensor(unittest.TestCase):
    ...
    def test_get_detected_objects_in_frame__nominal(self):
        ...
        SimulatedSensorUtilities.get_scene_detected_objects = MagicMock(return_value=self.detected_objects)
        SimulatedSensorUtilities.prefilter = MagicMock(return_value=self.detected_objects)
        ...
        SimulatedSensorUtilities.compute_actor_angular_extents = MagicMock(return_value=self.detected_objects)
        SimulatedSensorUtilities.compute_adjusted_detection_thresholds = MagicMock(return_value=self.detected_objects)
        SimulatedSensorUtilities.apply_occlusion = MagicMock(return_value=self.detected_objects)
        SimulatedSensorUtilities.apply_noise = MagicMock(return_value=self.detected_objects)
...
class TestSimulatedSensorUtilities(unittest.TestCase):
    ...
    def test_get_scene_detected_objects(self):
        ...
        result = SimulatedSensorUtilities.get_scene_detected_objects(self.carla_world, self.config)
    ...
    def test_prefilter(self):
        ...
        result = SimulatedSensorUtilities.prefilter(self.sensor, detected_objects, self.config)
        ...
        result = SimulatedSensorUtilities.prefilter(self.sensor, self.detected_objects, self.config)
    ...
    def test_compute_view_angle(self):
        ...
        result = SimulatedSensorUtilities.compute_view_angle(sensor, np.array([1.0, 1.0, 0.0]))
    ...
    def test_compute_adjusted_detection_thresholds(self):
        ...
        result = SimulatedSensorUtilities.compute_adjusted_detection_thresholds(config, sensor, detected_objects)

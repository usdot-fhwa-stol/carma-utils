...
class SimulatedSensorUtilities:
    ...
    def compute_actor_angular_extent(self, sensor, sensed_object):
    ...
    def compute_view_angle(self, relative_object_position_vectors):
    ...
    def compute_adjusted_detection_threshold(self, relative_object_position_vector):
    ...
    def is_visible(self, sensed_object, actor_angular_extent, sensor, hitpoints, detection_thresholds):

...
//  1.2.5   Claes Rol�n     2019-01-04  Removed warnings in Visual Studio. Bug fix in PNM class write_header().
//                                      Added flush_buf()/draw_now() in gplot
//  1.2.6   Claes Rol�n     2019-08-01  Added fast_plot(), improved performance for image(), mesh() and surf(). 
//                                      Removed need of -Dunix flag.
//  1.2.7   Claes Rol�n     2019-09-24  Bug fix in sp_version(), made it inline. 
